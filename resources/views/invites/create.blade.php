...
@section('content')
  <div class="box box-info">
      ...
      <input type="hidden" name="manager" id="manager" value="{{ $project->manager }}">
       {{ csrf_field() }}
        <div class="box-body">
          <div class="form-group">
            <label for="title" class="col-sm-2 control-label">Para: </label>
            <div class="col-sm-10">
              <input class="form-control" id="mail" name="mail" type="text" placeholder="Colaborador@ejemplo.cl" required>
            </div>
          </div>
          <div class="form-group">
